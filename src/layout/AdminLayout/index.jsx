...
function AdminLayout() {
    return (
        <div className="w-full bg-slate-50 h-screen relative">
            ...
            <div className="flex flex-col w-64 -translate-x-64 h-screen bg-slate-700 absolute z-40 invisible lg:translate-x-0 lg:visible transition-all ">
            ...
            <div className="grid grid-cols-1 gap-5 pt-24 px-5 w-full md:grid-cols-2 lg:pl-72">
                <div className="min-h-24 p-5 bg-slate-400 rounded-lg">
                    <h2>Xin chào</h2>
