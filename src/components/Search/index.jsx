...
const Search = () => {
    ...
    return (
        <>
            <div className="hidden md:flex md:flex-row md:items-center md:w-64 md:lg:w-96" ref={dropdownRef}>
                    ...
                    {showDropdown && (
                        <div className="z-10 absolute bg-white drop-shadow-lg rounded-br overflow-y-auto mt-1 lg:mt-3 translate-y-1/2 w-56 lg:w-80 border border-gray-300">
                            <ul className="md:text-sm lg:text-base">
                                <li className="hover:bg-slate-300 cursor-pointer p-1  hover:text-black/75">Cà phê cùng tony</li>
                                <li className="hover:bg-slate-300 cursor-pointer p-1  hover:text-black/75">Thời niên thiếu không thể quay lại ấy</li>
                            </ul>
                        </div>
                    )}
