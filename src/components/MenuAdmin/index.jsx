        ...
        <div className={clsx(stateMenu && "visible translate-x-0", !stateMenu && "invisible -translate-x-64", "flex flex-col w-64 h-screen bg-slate-800 absolute z-50 lg:translate-x-0 lg:visible transition-all overflow-y-scroll lg:overflow-y-auto overscroll-none")}>
            ...
            <ul className="mt-5 px-4">
                ...
                <li className={clsx(stateMenuChild[1] && 'bg-slate-900 rounded-sm', 'p-2')}>
                    <Link to="" className="flex items-center relative space-x-2" onClick={() => showMenuChild(1)}>
                    ...
                    <div className={clsx(stateMenuChild[1] && 'flex flex-col pl-10 space-y-2', !stateMenuChild[1] && "hidden")}>
                        <Link className='font-medium text-base text-slate-400 hover:text-slate-50 transition-colors' to="">Quản lý sản phẩm</Link>
                ...
                <li className={clsx(stateMenuChild[2] && 'bg-slate-900 rounded-sm', 'p-2')}>
                    <Link to="" className="flex items-center relative space-x-2" onClick={() => showMenuChild(2)}>
                ...
                <li className={clsx(stateMenuChild[3] && 'bg-slate-900 rounded-sm', 'p-2')}>
                    <Link to="" className="flex items-center relative space-x-2" onClick={() => showMenuChild(3)}>
                ...
                <li className={clsx(stateMenuChild[6] && 'bg-slate-900 rounded-sm', 'p-2')}>
                    <Link to="" className="flex items-center relative space-x-2" onClick={() => showMenuChild(6)}>
