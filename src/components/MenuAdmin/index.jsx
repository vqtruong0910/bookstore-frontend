...
function MenuAdmin({ stateMenu }) {
    ...
    const locationPage = useCallback((pageCurrent) => {
            ...
            <ul className="mt-4 px-4">
                <li className='p-2'>
                    <Link className='flex items-center space-x-2 text-slate-200' to={PATH.admin.dashboard}>
                        ...
                        <span className={clsx('font-medium text-base hover:text-slate-50 transition-colors', locationPage(PATH.admin.dashboard))}>Bảng điều khiển</span>
                    </Link>
                </li>
                ...
                <li className={clsx(stateMenuChild[2] && 'bg-slate-900 rounded-sm', 'p-2')}>
                    ...
                    <div className={clsx(stateMenuChild[2] && 'flex flex-col pl-10 space-y-2', !stateMenuChild[2] && "hidden")}>
                        <Link className={clsx('font-medium text-base text-slate-400 hover:text-slate-50 transition-colors', locationPage(PATH.admin.user_management))} to={PATH.admin.user_management}>Quản lý tài khoản</Link>
                    </div>
                </li>
