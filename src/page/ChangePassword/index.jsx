...
function ChangePassword() {
    ...
    const EmailVerify = useMemo(() => {
        const token = jwtDecode(searchParams.get("token"));
        return token.Email;
    }, [searchParams]);
    ...
    const onSubmit = useCallback(async (data) => {
        try {
            ...
            const res = await axiosConfig(API.RESETPASSWORD, { newPassword, resetPasswordToken });
    ...
    return (
        <div className="flex flex-col rounded-lg bg-white shadow-xl border">
            ...
            <form action="" method="post" onSubmit={handleSubmit(onSubmit)}>
                ...
                <Textfield type="password" marginX="mx-4" marginT="mt-4" marginB="mb-2" placeholder="Nhập lại mật khẩu" control={control} name="newPassword" rules={VALIDATE.password} />
