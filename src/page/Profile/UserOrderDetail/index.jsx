...
import LoadingSkeletonDetailOrder from '../../../components/Loading/LoadingSkeletonDetailOrder'
...
function UserOrderDetail() {
  ...
  return (
    <>
      {loading && <LoadingSkeletonDetailOrder />}
      {!loading && (
          ...
          <div>
            <div className="flex flex-wrap w-full md:mx-0 md:rounded-sm md:bg-white md:shadow-md">
              ...
              {orderDetail.map((item, index) => (
                <div
                  key={index}
                  className="hidden md:w-full md:flex md:flex-wrap md:justify-between "
                >
